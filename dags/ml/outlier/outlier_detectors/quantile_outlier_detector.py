...
from ml.outlier.outlier_detectors.outlier_detector_params import QuantileOutlierDetectorParams, \
    DefaultOutlierDetectorParams, OutlierDetectorTypeEnum
...
class QuantileOutlierDetector(BaseOutlierDetector):
    """Quantile outlier detector"""

    def __init__(
            self,
            params: Union[DefaultOutlierDetectorParams, QuantileOutlierDetectorParams]
    ):
        self.params = params
    ...
    def apply(
        ...
        query = sql_template.get_quantile_outliers_template(
            first_groupby,
            second_groupby
        )
        print(query)
