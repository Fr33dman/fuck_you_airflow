...
class BaseMetric:
    ...
    def median_duration(self):
        ...
        result: pandas.Series
        """
        return (self._group_data[self._dh.duration_column].median() / self._time_unit).rename("median_duration")
    ...
    def variance_duration(self):
        ...
        result: pandas.Series
        """
        return (self._group_data[self._dh.duration_column].var(ddof=0) / self._time_unit).rename(
            "variance_duration"
        )
    ...
    def std_duration(self):
        ...
        result: pandas.Series
        """
        return (self._group_data[self._dh.duration_column].std(ddof=0) / self._time_unit).rename("std_duration")
