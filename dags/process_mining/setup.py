...
def remove_all_pycache():
    run(["pip", "install", "pyclean", "-q"])
    run(["python", "-m", "pyclean", "."])
...
setup(
    ...
    url="https://stash.sigma.sbrf/projects/RDB/repos/sberpm",
    author="Sberbank Process Mining Team",
    author_email="AABugaenko@sberbank.ru",
    packages=get_packages(),
    include_package_data=True,
    classifiers=[
        "Intended Audience :: Developers and Analysts",
